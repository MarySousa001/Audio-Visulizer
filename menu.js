...
function setup() {
	...
	let sim4 = new ButtonEffect(null,null,200,60,"#45ffa5","Sputnik", new Sputnik());
	SIMMenu = new EffectsMenu([sim1,sim2,sim3,sim4], "SIM", 3, "#45ffa5", map(2,0,3,width/4,3/4*width), height-55);
